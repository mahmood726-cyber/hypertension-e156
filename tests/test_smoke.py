"""Import-smoke + pure-function tests for hypertension-e156 (Bucket-B no-tests remediation).
...
_SCRIPT = os.path.join(
    ...
    'code', 'build_e156_bundle.py')


def _load():
    sys.path.insert(0, os.path.dirname(_SCRIPT))
    spec = importlib.util.spec_from_file_location("buildmod_hypertension_e156", _SCRIPT)
