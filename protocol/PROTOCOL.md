...
Registry-first Africa-site hypertension randomized trials as a transfer template for cheaper and faster RCT delivery.
...
Estimate the proportion of Africa-site hypertension randomized trials that meet a pragmatic transfer shortlist defined by smaller enrollment, lower site and country footprint, prospective registration, and completed results posting.
...
Shortlist proportion among Africa-site benchmark trials. In the current analysis this was `8/65` with Wilson 95% interval `0.06` to `0.22`.
...
- Benchmark trials: `65`
- Total enrolled participants across benchmark records: `289309`
- Median trial duration days: `999.0`
- Median results-reporting lag days: `504.0`
- Most represented Africa-site countries: South Africa (45), Uganda (7), Kenya (6), Egypt (5), Nigeria (4)
- Shortlist sponsor mix: OTHER (6), INDUSTRY (1), NIH (1)
